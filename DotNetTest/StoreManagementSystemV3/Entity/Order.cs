...
using StoreManagementSystemV3.Entity.Enum;
using System;
...
namespace StoreManagementSystemV3.Entity
{
    ...
    public class Order : EntityBase
    {
        ...
        public void UpOrderStatus(OrderStatusType orderStatus)
        {
            ...
            Console.WriteLine($"{(this.OrderName).PadRight(15 - this.OrderName.Length)}  单号:{this.No.PadRight(40 - this.No.Length)}  {this.OrderStatus.ToString().PadRight(10 - this.OrderStatus.ToString().Length)}  {DateTime.Now}");
        }
