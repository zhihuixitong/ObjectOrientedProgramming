        ...
        public static List<Device> Devices3 = new List<Device>()
        {
            new Device("电视",
                 new List<DeviceInstruct>()
                    {
                        new DeviceInstruct("关", Entity.Enum.DeviceStatusType.电视关了,true),
                        new DeviceInstruct("开", Entity.Enum.DeviceStatusType.打开电视),
                    }
                 ),
            new Device("冰箱",
                 new List<DeviceInstruct>()
                    {
                        new DeviceInstruct("关", Entity.Enum.DeviceStatusType.冰箱关了,true),
                        new DeviceInstruct("开", Entity.Enum.DeviceStatusType.打开冰箱),
                    }
                 ),
        };
